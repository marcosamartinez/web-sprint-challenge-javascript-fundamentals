...
// The reason why nestedFunction can access the var internal is they are both bound to the same function. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(item) {
    const lowerCaseName = zooAnimals.map(item => item.animal_name.toLowerCase());
  ...
  */
  ...
  function USApop(item) {
    const usaAnimalPop = zooAnimals.reduce(function(acc, item) {
  ...
  */
  ...
  console.log(consume(4, 5, USApop ))
...
function greeting(firstname, lastname){
  ...
  console.log(greeting("Marcos","Martinez"))
...
var values = {length: 4, width: 5, height: 5}
const cuboid = new CuboidMaker(values)
...
var value = {length: 4, width: 5, height: 5}
const cuboidTwo = new CuboidMakerTwo (value)
